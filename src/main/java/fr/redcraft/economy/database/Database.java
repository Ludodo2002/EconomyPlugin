...
import fr.redcraft.economy.helper.UUIDFetcher;
...
public abstract class Database {
    private Main plugin;
    private Set<Account> cachedAccounts;
    ...
    protected boolean convertToUUID() {
        ...
        Main.getInstance().getLogger().info("Starting UUID conversion.");
        ...
        try {
            ...
            e.printStackTrace();
            Main.getInstance().getLogger().info("UUID conversion failed, disabling Economy!");
            plugin.getServer().getPluginManager().disablePlugin(plugin);
            return false;
        }
        Main.getInstance().getLogger().info("UUID conversion has succeeded!");
        return true;
    }
